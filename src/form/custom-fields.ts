...
import { Conditional, Conditionals, SerializedFormField } from './types/types'
...
export function getBirthAttendantFullName(conditionals:Conditional[]): SerializedFormField {
  const fieldName: string = 'birthAttendantFullName'
  const fieldId: string = `birth.child.child-view-group.${fieldName}`
  ...
  return {
    ...
    type: 'TEXT', // ANY FORM FIELD TYPE IS POSSIBLE. ADD ADDITIONAL PROPS AS REQUIRED.  REFER TO THE form/README.md FILE
    label: {
      id: 'form.customField.label.birthAttendantFullName',
      description: 'A form field that asks for the birth attendant full name.',
      defaultMessage: 'Birth attendent full name'
    },
    initialValue: '',
    validator: [], // EDIT VALIDATORS AS YOU SEE FIT
    mapping: getCustomFieldMapping(fieldId), // ALL CUSTOM FIELDS MUST USE THIS MAPPING FUNCTION
...
export function getBirthAttendantID(conditionals:Conditional[]): SerializedFormField {
  const fieldName: string = 'birthAttendantID'
  const fieldId: string = `birth.child.child-view-group.${fieldName}`
  ...
  return {
    ...
    type: 'TEXT', // ANY FORM FIELD TYPE IS POSSIBLE. ADD ADDITIONAL PROPS AS REQUIRED.  REFER TO THE form/README.md FILE
    label: {
      id: 'form.customField.label.birthAttendantID',
      description: 'A form field that asks for the birth attendant ID.',
      defaultMessage: 'Birth attendent ID'
    },
    initialValue: '',
    validator: [], // EDIT VALIDATORS AS YOU SEE FIT
    mapping: getCustomFieldMapping(fieldId), // ALL CUSTOM FIELDS MUST USE THIS MAPPING FUNCTION
