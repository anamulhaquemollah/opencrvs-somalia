...
export const birthDocumentType = {
  ...
  ACQUIRED_CHILD_COURT_DOCUMENT: 'ACQUIRED_CHILD_COURT_DOCUMENT',
      ...
      fields: [
        ...
        },
        {
          ...
          options: [
            ...
            {
              value: birthDocumentType.VACCINATION_CARD, 
              label: formMessageDescriptors.docTypeVaccinationCard
            }, 
            {
        ...
        },
        {
          ...
          options: [
            {
              value: birthDocumentType.ACQUIRED_CHILD_COURT_DOCUMENT,
              label: formMessageDescriptors.acquiredChildCourtDocument
            },
            {
