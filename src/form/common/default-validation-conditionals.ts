...
export const birthAttendantNotNone = '((values.attendantAtBirth === "NONE") || (!values.attendantAtBirth))'
export const birthAttendantOnlyNurse = '((values.attendantAtBirth !== "NURSE"))'
