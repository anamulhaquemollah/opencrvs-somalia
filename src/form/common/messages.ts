...
export const formMessageDescriptors = {
  ...
  informantType: {
    ...
    id: 'form.field.label.informantType'
  },
  informantTypeOther: {
    defaultMessage: 'Other',
    description: 'Label for Informant type Other',
    id: 'form.field.label.informantTypeOther'
  },
  ...
  acquiredChildCourtDocument: {
    defaultMessage: 'Proof of acquired child court document',
    description: 'Label for document option Proof of acquired child court document',
    id: 'form.field.label.acquiredChildCourtDocument'
  },
